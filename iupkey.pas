...
implementation
    ...
    function iup_isShiftXkey(_c : DWORD)
           : boolean32; inline;
    begin
      iup_isShiftXkey := _c and DWORD($10000000) > 0;
    end;
    ...
    function iup_isCtrlXkey(_c : DWORD)
           : boolean32; inline;
    begin
      iup_isCtrlXkey := _c and DWORD($20000000) > 0;
    end;
    ...
    function iup_isAltXkey(_c : DWORD)
           : boolean32; inline;
    begin
      iup_isAltXkey := _c and DWORD($40000000) > 0;
    end;
    ...
    function iup_isSysXkey(_c : DWORD)
           : boolean32; inline;
    begin
      iup_isSysXkey := _c and DWORD($80000000) > 0;
    end;
end.
