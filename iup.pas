...
{$ENDIF}
  ...
  procedure IupLog(_type:Pchar; format:Pchar);cdecl;varargs;external External_library name 'IupLog';
  ...
  function IupSetAtt(handle_name:Pchar; ih:PIhandle; name:Pchar):PIhandle;cdecl;varargs;external External_library name 'IupSetAtt';
  ...
  procedure IupSetStrf(ih:PIhandle; name:Pchar; format:Pchar);cdecl;varargs;external External_library name 'IupSetStrf';
  ...
  procedure IupSetStrfId(ih:PIhandle; name:Pchar; id:longint; format:Pchar);cdecl;varargs;external External_library name 'IupSetStrfId';
  ...
  procedure IupSetStrfId2(ih:PIhandle; name:Pchar; lin:longint; col:longint; format:Pchar);cdecl;varargs;external External_library name 'IupSetStrfId2';
  ...
  function IupSetCallbacks(ih:PIhandle; name:Pchar; func:Icallback):PIhandle;cdecl;varargs;external External_library name 'IupSetCallbacks';
  ...
  function IupCreatep(classname:Pchar; first:pointer):PIhandle;cdecl;varargs;external External_library name 'IupCreatep';
  ...
  function IupVbox(child:PIhandle):PIhandle;cdecl;varargs;external External_library name 'IupVbox';

  function IupVboxv(children:PPIhandle):PIhandle;cdecl;external External_library name 'IupVboxv';

  function IupZbox(child:PIhandle):PIhandle;cdecl;varargs;external External_library name 'IupZbox';

  function IupZboxv(children:PPIhandle):PIhandle;cdecl;external External_library name 'IupZboxv';

  function IupHbox(child:PIhandle):PIhandle;cdecl;varargs;external External_library name 'IupHbox';

  function IupHboxv(children:PPIhandle):PIhandle;cdecl;external External_library name 'IupHboxv';

  function IupNormalizer(ih_first:PIhandle):PIhandle;cdecl;varargs;external External_library name 'IupNormalizer';

  function IupNormalizerv(ih_list:PPIhandle):PIhandle;cdecl;external External_library name 'IupNormalizerv';

  function IupCbox(child:PIhandle):PIhandle;cdecl;varargs;external External_library name 'IupCbox';
  ...
  function IupGridBox(child:PIhandle):PIhandle;cdecl;varargs;external External_library name 'IupGridBox';

  function IupGridBoxv(children:PPIhandle):PIhandle;cdecl;external External_library name 'IupGridBoxv';

  function IupMultiBox(child:PIhandle):PIhandle;cdecl;varargs;external External_library name 'IupMultiBox';
  ...
  function IupMenu(child:PIhandle):PIhandle;cdecl;varargs;external External_library name 'IupMenu';
  ...
  function IupTabs(child:PIhandle):PIhandle;cdecl;varargs;external External_library name 'IupTabs';

  function IupTabsv(children:PPIhandle):PIhandle;cdecl;external External_library name 'IupTabsv';

  function IupFlatTabs(first:PIhandle):PIhandle;cdecl;varargs;external External_library name 'IupFlatTabs';
  ...
  procedure IupSetfAttribute(ih:PIhandle; name:Pchar; format:Pchar);cdecl;varargs;external External_library name 'IupSetfAttribute';
  ...
  procedure IupSetfAttributeId(ih:PIhandle; name:Pchar; id:longint; f:Pchar);cdecl;varargs;external External_library name 'IupSetfAttributeId';
  ...
  procedure IupSetfAttributeId2(ih:PIhandle; name:Pchar; lin:longint; col:longint; format:Pchar);cdecl;varargs;external External_library name 'IupSetfAttributeId2';
  ...
  procedure IupMessagef(title:Pchar; format:Pchar);cdecl;varargs;external External_library name 'IupMessagef';
  ...
  function IupScanf(format:Pchar):longint;cdecl;varargs;external External_library name 'IupScanf';
  ...
  function IupGetParam(title:Pchar; action:Iparamcb; user_data:pointer; format:Pchar):longint;cdecl;varargs;external External_library name 'IupGetParam';
  ...
  function IupParamBox(param:PIhandle):PIhandle;cdecl;varargs;external External_library name 'IupParamBox';
...
implementation
  ...
  function isshift(_s : Pchar) : boolean;
  begin
    isshift:= iup_isshift(_s);
  end;

  function iscontrol(_s : Pchar) : boolean;
  begin
    iscontrol:= iup_iscontrol(_s);
  end;

  function isbutton1(_s : Pchar) : boolean;
  begin
    isbutton1:= iup_isbutton1(_s);
  end;

  function isbutton2(_s : Pchar) : boolean;
  begin
    isbutton2:= iup_isbutton2(_s);
  end;

  function isbutton3(_s : Pchar) : boolean;
  begin
    isbutton3:= iup_isbutton3(_s);
  end;

  function isdouble(_s : Pchar) : boolean;
  begin
    isdouble:= iup_isdouble(_s);
  end;
  ...
  function isbutton4(_s : Pchar) : boolean;
  begin
    isbutton4:= iup_isbutton4(_s);
  end;

  function isbutton5(_s : Pchar) : boolean;
  begin
    isbutton5:= iup_isbutton5(_s);
  end;
